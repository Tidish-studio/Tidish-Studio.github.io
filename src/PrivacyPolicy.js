...
const PrivacyPolicy = () => {
    return (
        <Container
            sx={{ fontFamily: 'Helvetica Neue, Helvetica, Arial, sans-serif', padding: '1em' }}
            maxWidth="md"
        >
            <strong>Privacy Policy</strong>{' '}
            <p>
                Tidish-Studio built the Spellbook 5e app as a Free app. This SERVICE is provided by
                Tidish-Studio at no cost and is intended for use as is.
            </p>{' '}
            <p>
            ...
            <p>
                ...
                Conditions, which are accessible at Spellbook 5e unless otherwise defined in this
                Privacy Policy.
            </p>{' '}
            <p>
            ...
            <p>
                ...
                app I collect data and information (through third-party products) on your phone
                ...
                the app when utilizing my Service, the time and date of your use of the Service, and
                other statistics.
            </p>{' '}
            <p>
            ...
            <div>
                <p>
                    ...
                    information, please contact me so that I will be able to do the necessary
                    actions.
                </p>
            </div>{' '}
            <p>
            ...
            <p>
                ...
                contact me at tidishstudio@gmail.com.
            </p>
        </Container>
    );
};
